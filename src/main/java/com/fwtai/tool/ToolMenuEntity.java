...
/**
 * 组装无限极导航菜单,bean实现
 * @用法 final List<Menu> rootMenu = new ToolMenuEntity().initMenu(lists,"88888888888888888888888888888888");
 * @作者 田应平
 * @版本 v1.0
...
public final class ToolMenuEntity{
    ...
    /**组装菜单数据,用法：final List<Menu> rootMenu = new ToolMenuEntity().initMenu(lists,"88888888888888888888888888888888"); */
